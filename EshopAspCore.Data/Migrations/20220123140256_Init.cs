    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2a905b66-98fb-4e82-9d98-5cf68ebb16ea"), "df1ebb0a-dbdd-4f18-9315-f1f1e403985e", "Administrator role", "admin", "admin" },
                    { new Guid("425bc5f9-b61a-45b4-a319-d7fc963871dd"), "a290f4f1-418a-48cf-9609-ec9a32811df9", "user role", "user", "user" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("db9ed923-492b-467a-97e4-ee81c9de0a64"), 0, "151eefc1-1caf-4830-bbf4-4c043d51b2b1", new DateTime(1998, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "some-admin-email@nonce.fake", true, "Trung", "Do", false, null, "some-admin-email@nonce.fake", "admin", "AQAAAAEAACcQAAAAEA8lcpITZy7VM8xvP/NpL/Cuh3KPNKudtjxSCvAYiY0ePD3OXOcu9HxM6xBc/poKEw==", null, false, "", false, "trung123" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 1, 23, 21, 2, 55, 922, DateTimeKind.Local).AddTicks(1621), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "vi", "Áo nữ", "ao-nu", "Sản phẩm áo thời trang nu", "Sản phẩm áo thời trang nu" },
                    { 2, 1, "en", "Men shirt", "men-shirt", "The shirt produtcs for men", "The shirt producs for men" },
                    { 4, 2, "en", "Women shirt", "Women-shirt", "The shirt produtcs for women", "The shirt producs for women" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, "vi", "Áo hoodie nam", 1, "ao-hoodie-nam", "Sản phẩm áo hoodie nam", "Sản phẩm áo hoodie nam" },
                    { 2, null, null, "en", "hoodie shirt for men", 1, "hoodie-shirt-for-men", "The hoodie shirt produtcs for men", "The hoodie shirt products for men" }
                });
